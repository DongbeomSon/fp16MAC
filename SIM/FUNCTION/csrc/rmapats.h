...
typedef struct TableAssignLayoutOnClk_ {
    struct TableAssignLayoutOnClk_ * I871;
    struct TableAssignLayoutOnClk_ * I790;
    U  I5;
    U  I1025 :1;
    U  I1026 :1;
    U  I1027 :2;
...
struct futq_slot1 {
    U  I747;
    struct futq_slot2  I748[32];
};
struct futq_info {
    U  I743;
    U  I744;
    struct futq_slot1  I745[32];
};
struct futq {
    struct futq * I733;
    struct futq * I735;
...
struct dummyq_struct {
    ...
    int I1173;
    int I1174;
    struct vcs_globals_t * I1175;
    clock_struct  I1176;
    unsigned long long I1177;
    EBLK  * I1178;
    EBLK  * I1179;
    void * I1180;
};
...
void  hs_0_M_25_1__simv_daidir (UB  * pcode, scalar  val, U  I661, scalar  * I1223, U  did);
...
void  hs_0_M_26_1__simv_daidir (UB  * pcode, scalar  val, U  I661, scalar  * I1223, U  did);
...
void  hs_0_M_30_1__simv_daidir (UB  * pcode, scalar  val, U  I661, scalar  * I1223, U  did);
...
void  hs_0_M_31_1__simv_daidir (UB  * pcode, scalar  val, U  I661, scalar  * I1223, U  did);
...
void  hs_0_M_32_1__simv_daidir (UB  * pcode, scalar  val, U  I661, scalar  * I1223, U  did);
...
void  hs_0_M_63_1__simv_daidir (UB  * pcode, scalar  val, U  I661, scalar  * I1223, U  did);
...
void  hs_0_M_71_1__simv_daidir (UB  * pcode, scalar  val, U  I661, scalar  * I1223, U  did);
...
void  hs_0_M_72_1__simv_daidir (UB  * pcode, scalar  val, U  I661, scalar  * I1223, U  did);
...
void  hs_0_M_73_1__simv_daidir (UB  * pcode, scalar  val, U  I661, scalar  * I1223, U  did);
